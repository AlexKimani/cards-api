...
public enum ErrorCode {
    ...
    ERROR_1006("1006", "Authorization Failed."),
    ...
    ERROR_1604("1604", "This card does not exist."),
    ERROR_1605("1605", "Successfully deleted card, id: %d"),
    ERROR_1606("1606", "All cards deleted."),
    ERROR_1609("1609", "This card name already exists.");
